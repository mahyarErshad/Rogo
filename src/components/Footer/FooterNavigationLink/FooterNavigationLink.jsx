  ...
  return (
    ...
    <Box sx={{display:'flex', flexDirection:"row-reverse"}}>
        <Box sx={{display:'flex', flexDirection:"column"}}>
            ...
            { navLinks.map((item) =>{
              return (<Box dir="rtl" className="footerNavLink" sx={{fontSize:"0.9rem", fontWeight:"100", mt:"1rem", transition: "all 0.3s ease-in-out 0.01s", color:"#a6a6a6", "&:hover":{color:"#e60f44"}}}>
              {item}
          </Box>)
            }) }
        </Box>
